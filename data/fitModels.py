...
def fitModels(roundSplit,XTrain,YTrain,XTest = None,YTest = None,createTest = False):
	...
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=175,n_jobs=8,max_depth=5),"RF_5_175")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=175,n_jobs=8,max_depth=10),"RF_10_175")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=175,n_jobs=8,max_depth=15),"RF_15_175")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=175,n_jobs=8,max_depth=20),"RF_20_175")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=175,n_jobs=8,max_depth=25),"RF_25_175")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=175,n_jobs=8,max_depth=30),"RF_30_175")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=200,n_jobs=8,max_depth=5),"RF_5_200")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=200,n_jobs=8,max_depth=10),"RF_10_200")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=200,n_jobs=8,max_depth=15),"RF_15_200")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=200,n_jobs=8,max_depth=20),"RF_20_200")
	testModel(roundSplit,XTrain,YTrain,XTest,YTest,RandomForestClassifier(n_estimators=200,n_jobs=8,max_depth=25),"RF_25_200")
